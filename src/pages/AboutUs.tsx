          ...
          <Title level={1} style={{fontSize: token.fontSizeHeading3, lineHeight: '150%'}}>研达创新EETL | 28年电子元器件代理专家 | 一站式供应链服务</Title>
            ...
            <Flex vertical>
              <Paragraph className='text-indent font-size1' style={{lineHeight: '200%'}}>
                研达创新电子（简称 EETL）始创于 1997 年，总部位于深圳市南山区西丽大学城片区的众冠时代广场，毗邻美丽的大沙河和西丽湖。公司致力于为电子终端产品制造商提供专业的电子元器件供应链服务，凭借自身努力与国内外多家著名电子元器件厂家建立了长期战略性的合作关系，成为其在中国大陆及中国香港地区的代理商。
              </Paragraph>
              <Paragraph className='text-indent font-size1 mb-0' style={{ lineHeight: '200%' }}>
              EETL 在电子元器件行业中占据了独特的地位，EETL 的产品和服务广泛应用于多个领域，包括但不限于：
              </Paragraph>
              <ul className='font-size1 mb-10' style={{ lineHeight: '200%', paddingLeft: '2em',listStyle: 'inside' }}>
                <li>消费电子：为各类消费电子产品提供高性价比的元器件。</li>
              ...
              <Paragraph className='text-indent font-size1' style={{ lineHeight: '200%' }}>
                EETL 的市场销售团队结合各品牌的产品优势，借助多年在各应用领域的深耕经验，成功地在不同领域的新市场中成为各品牌的重要合作伙伴。公司不仅在中国大陆设有总部，在香港、上海、北京、日本、伯明翰等地也设有销售据点，形成了广泛的销售网络。
              </Paragraph>
          </Flex>
          </Col>
        </Row>
